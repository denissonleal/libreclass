            ...
            <div class="row">
            	<div class="col-xs-12">
								<div class="list-inline">
									...
									<button class="btn btn-default btn-block-xs delete-unit" url='{{ URL::to("/classes/offers/delete-last-unit/".encrypt($offer->id)) }}'><i class="fa fa-trash fa-fw"></i>Deletar Unidade</button>
								</div>
            	</div>
            </div>
